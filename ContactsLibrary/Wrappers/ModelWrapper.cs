...
namespace Contacts.Wrappers
{
    public class ModelWrapper<T> : NotifyDataErrorInfoBase, IValidatableTrackingObject, IValidatableObject
    {
        ...
        public ModelWrapper(T model, CollectionInitialization initializeCollection = CollectionInitialization.DoNotInitialize)
        {
            if (model is null)
            {
            ...
            if (initializeCollection == CollectionInitialization.Initialize) { InitializeCollectionProperties(model); }
